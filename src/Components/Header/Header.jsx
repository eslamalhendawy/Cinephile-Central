...
function Header() {
  ...
  return (
    <>
      <nav className="py-4 px-4 sm:px-12 bg-white sm:flex sm:items-center sm:justify-between container mx-auto">
        <div className="flex justify-between items-center w-full sm-w-auto">
          <h1 className="text-xl sm:text-2xl md:text-4xl lg:text-5xl">Cinephile Central</h1>
        ...
        <ul ref={menu} className="sm:flex sm:space-x-6 sm:items-center z-[-1] sm:z-auto sm:static absolute bg-white w-full left-0 sm:w-auto sm:py-0 py-4 sm:pl-0 pl-4 sm:opacity-100 opacity-0 top-[-400px] transition-all ease-in duration-300">
          <li className="text-lg ">Home</li>
          <li className="text-lg ">Movies</li>
          <li className="text-lg  whitespace-nowrap">TV Shows</li>
        </ul>
      </nav>
      <div className="container mx-auto px-4 sm:px-12 mt-4 ">
        <div className="bg-[#233a50] border-2 sm:border-4 border-black flex rounded-xl">
          ...
          <input className="placeholder:text-white focus:placeholder:opacity-0 placeholder:duration-300 p-1 sm:p-3 block w-full text-white bg-[#233a50] focus:outline-none rounded-r-xl" type="text" placeholder="Search..." />
        </div>
      </div>
    </>
  );
